...
{  int i; m_tree_t *t; ;
   ...
   printf("test_print_submeasure");
   m_tree_t *t2; ;
   printf("starting \n");
   t2 = create_m_tree();
  //  TA will check the print out manually
   insert_interval(t2, 1, 0);
   insert_interval(t2, 1, 2);
   print_submeasures(t2);
   insert_interval(t2, 2, 4);
   insert_interval(t2, 6, 10);
   print_submeasures(t2);
   insert_interval(t2, 7, 8);
   insert_interval(t2, 7, 11);
   insert_interval(t2, -1, 1);
   print_submeasures(t2);
   insert_interval(t2, -5, -3);
   print_submeasures(t2);
   insert_interval(t2, -6, -4);
   print_submeasures(t2);
   insert_interval(t2, -7, 11);
   print_submeasures(t2);

   printf("test_max_submeasure");
   m_tree_t *t3; ;
   printf("starting \n");
   t3 = create_m_tree();
   insert_interval(t3, 1, 0);
   insert_interval(t3, 1, 2);
   printf("max_submeasure %d, should be 1.\n", max_submeasure(t3));

   insert_interval(t3, 2, 4);
   insert_interval(t3, 6, 10);
   printf("max_submeasure %d, should be 6.\n", max_submeasure(t3));

   insert_interval(t3, 7, 8);
   insert_interval(t3, 7, 11);
   printf("max_submeasure %d, should be 2 or 8.\n", max_submeasure(t3));

   insert_interval(t3, -1, 1);
   insert_interval(t3, -5, -3);
   printf("max_submeasure %d, should be -5 or -1 or 2 or 8.\n", max_submeasure(t3));

   insert_interval(t3, -6, -4);
   insert_interval(t3, -7, 11);
   printf("max_submeasure %d, should be -3 or -1 or 2 or 4 or 8.\n", max_submeasure(t3));
}